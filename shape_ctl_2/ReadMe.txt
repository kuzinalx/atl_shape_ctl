========================================================================
    ACTIVE TEMPLATE LIBRARY : shape_ctl_2 Project Overview
========================================================================

AppWizard has created this shape_ctl_2 project for you to use as the starting point for
...
shape_ctl_2.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (shape_ctl_2.h)
        GUID definitions                                (shape_ctl_2_i.c)
        A type library                                  (shape_ctl_2.tlb)
        Marshaling code                                 (shape_ctl_2_p.c and dlldata.c)

shape_ctl_2.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in shape_ctl_2.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named shape_ctl_2.pch and a precompiled types file named StdAfx.obj.
...
shape_ctl_2ps.vcxproj
	...
	dlldata.c, shape_ctl_2_i.c and shape_ctl_2_p.c which are required
	to build the proxy/stub DLL.

shape_ctl_2ps.vcxproj.filters
