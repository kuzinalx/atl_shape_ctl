...
// CShapeSquare wrapper class

class CShapeSquare : public COleDispatchDriver
{
public:
	CShapeSquare(){} // Calls COleDispatchDriver default constructor
	CShapeSquare(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CShapeSquare(const CShapeSquare& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
